...
/**
 * Build file generator for plain Java project building with Gradle.
 */
class GradleKotlinBuildFileGenerator : BuildFileGenerator {
    override fun generate(dependencies: List<String>, printer: PrettyPrintStream) {
        printer.addBlock("plugins {")
        printer.printlnIndented("id 'org.jetbrains.kotlin.jvm' version '1.4.10'\n")
        printer.endBlock()
        printer.println()
